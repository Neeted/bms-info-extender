...
(function () {
  ...
  window.addEventListener("locationchange", resetActiveBmsPreviewRuntime);
  ...
  function ensureBmsDataStyleOnce() {
    PreviewRuntime.ensureBmsDataStyleOnce(document);
  }
  ...
  async function fetchBmsRecord(pageContext) {
    return PreviewRuntime.fetchBmsInfoRecordByIdentifiers(pageContext.identifiers);
  }
